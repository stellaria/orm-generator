...
public interface GeneratorService {
	 ...
	 * @throws IOException
	 */
	String cascadePOJOGenerator(String entityName, String tableName, String packageName, List<String> field, Map<String, String> refer) throws IOException;
	 ...
	 * @param packageName
	 * @param field key为数据库列名和类型,用;分隔 ，value为实体类属性名和属性类型，用;分割
	 * @param refer 关联column key,value均为实体类.实体属性
